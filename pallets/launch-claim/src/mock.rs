use frame_support::{PalletId, assert_ok, derive_impl, pallet_prelude::ConstU32, parameter_types};
...
mod runtime {
    ...
    pub type LaunchClaim = crate::Pallet<Test>;
}
...
pub fn new_test_ext() -> sp_io::TestExternalities {
    ...
    pallet_balances::GenesisConfig::<Test> {
        balances: vec![(1, 10000 * XOR), (2, 10 * XOR), (3, 3 * XOR), (10, 100 * XOR)],
        dev_accounts: None,
    }
    .assimilate_storage(&mut storage)
    .unwrap();
    crate::GenesisConfig::<Test> { funding_source_account: Some(1), owner: Some(1) }
        .assimilate_storage(&mut storage)
        .unwrap();
    ...
    ext.execute_with(|| {
        assert_ok!(LaunchClaim::add_relayer(RuntimeOrigin::signed(1), 10));
    });
    ext
}
